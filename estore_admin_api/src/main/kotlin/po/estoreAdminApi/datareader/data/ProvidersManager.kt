...
import po.estoreAdminApi.datareader.classes.ProviderDataListener
...
import po.estoreAdminApi.general.DataManagerMessage
    ...
    fun updateCategories(providerId: Int, container : DataFlowContainer? = null): SharedFlow<DataFlowContainer>{
        getDataProvider(providerId)?.let {
            providerManagerScope.launch {
                val resultingDataFlowContainer = it.updateCategories(container?: DataDispatcher.createDispatchContainer(
                    ModuleName.DATAREADER,"updateCategories"))
